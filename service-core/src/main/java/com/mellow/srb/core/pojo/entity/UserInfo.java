package com.mellow.srb.core.pojo.entity;
...
public class UserInfo implements Serializable {
    ...
    public static final String USERINFO_AVATAR = "https://srb-file-20210908.oss-cn-shenzhen.aliyuncs.com/avatar/headimg.jpg";
